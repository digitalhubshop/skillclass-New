      ...
      <header className="bg-gray-900 text-white">
        <div className="max-w-7xl mx-auto px-4 py-4 flex justify-between items-center">
          ...
          <div className="flex gap-3">
            <button onClick={() => navigate('/invite')} className="px-4 py-2 text-green-400 border border-green-400 rounded-lg hover:bg-green-900">
              📨 Invite
            </button>
            <button onClick={() => navigate('/messages')} className="px-4 py-2 text-blue-400 border border-blue-400 rounded-lg hover:bg-blue-900">
              💬 Messages
            </button>
